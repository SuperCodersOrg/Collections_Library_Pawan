...
TEST(DynamicArrayTest, initial_state) {
...
TEST(DynamicArrayTest, custom_capacity) {
...
TEST(DynamicArrayTest, element_access) {
...
TEST(DynamicArrayTest, append_and_resize) {
...
TEST(DynamicArrayTest, remove_and_pop) {
...
TEST(DynamicArrayTest, search_and_clear) {
...
TEST(DynamicArrayTest, copy_semantics) {
...
TEST(DynamicArrayTest, move_semantics) {
...
TEST(DynamicArrayTest, invalid_capacity) {
